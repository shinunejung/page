export const questions = [
  ...
  },
  {
    ...
    choices: [
      { text: '안녕하세요ㅎㅎ 잘 부탁드려요~<br>(부끄러워 >///<)', value: 'i' },
      { text: '안녕하세요! 저는 자취하고 있고요,<br>MBTI는 ~~ (빨리 친해져야지 >0<) ', value: 'e' }
    ]
  },
  {
    number: '06',
    ...
    choices: [
      { text: '날 좋은데 일이라니.<br>그런데 어쩌겠어? 일해야지!', value: 'j' },
      { text: '이럴 때 일할 순 없어!!<br>반차 써버릴 거야!', value: 'p' }
    ]
  },
  {
    number: '07',
    ...
    choices: [
      { text: '더 열심히 해서 잘할 수 있다는<br>사람이란 걸 보여주자!', value: 't' },
      { text: '내가 재능이 없나?<br>퇴사각..', value: 'f' }
    ]
  },
  {
    number: '08',
    ...
    choices: [
      { text: '시간을 더 끌 순 없지.<br>팀장님한테 당장 물어봐야지!', value: 'j' },
      { text: '어떡하지.. 야근하더라도<br>방법을 더 찾아봐야겠다. ', value: 'p' }
    ]
  },
  {
    number: '09',
    ...
    choices: [
      { text: '인생은 도전이야!<br>좋은 기회라고 생각하고 시작해볼래!', value: 'n' },
      { text: '지금 회사도 좋은데..<br>위험 부담을 안고 이직하는 게 맞을까?', value: 's' }
    ]
  },
  {
    number: '10',
    ...
    choices: [
      { text: '드디어 회사가 날 알아주는구나!<br>더 열심히 해야지!', value: 'p' },
      { text: '진급하면 월급도 오르겠지?<br>월급 오르면 ○○ 사야지~ (상상의 나래~)', value: 'j' }
    ]
  },
]
export const results = [
  ...
  {
    title: '샤를로트 드 오베르',
    character: '../images/Charlotte.png',
    results: [
  ...
  {
    title: '재클린 허스턴',
    character: '../images/Jacqueline.png',
    results: [
